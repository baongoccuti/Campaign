...
import {
    Col, Row, Typography, Spin, Button, Card, DatePicker, Empty, Input, Space,
...
import {
    ...
    CalendarOutlined, UserOutlined, TeamOutlined, HomeOutlined, HistoryOutlined, FileOutlined ,ShoppingOutlined,InfoCircleOutlined, FormOutlined, TagOutlined, EditOutlined
...
throw error;
    ...
    const handleUpdateCampaign = async (values) => {
        ...
        try {
            ...
            await campaignApi.updateCampaign(campaign, id).then(response => {
